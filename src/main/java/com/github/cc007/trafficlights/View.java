...
public abstract class View extends Canvas implements Observer, XMLSerializable {
 ...
 /*============================================*/
    ...
    /**
     * Adds an overlay to this view. An overlay has one of two types: buffer or
     * view. A buffer overlay is painted directly on the back buffer, a view
     * overlay on the front buffer.
     *
 ...
 /*============================================*/
    ...
    @Override
    public void saveChilds(XMLSaver saver) throws XMLTreeException, IOException, XMLCannotSaveException { 	// The view doesn't have any child objects
    }
