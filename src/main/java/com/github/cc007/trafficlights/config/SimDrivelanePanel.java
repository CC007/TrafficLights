...
public class SimDrivelanePanel extends ConfigPanel implements ActionListener, ItemListener {
    ...
    private class Queue extends Panel {
        ...
        public synchronized void reset() {
            ...
            while (resetTryCount > 0 && !done) {
                ...
                // SimModel thread changed the queue while we were updating, try again.
                    ...
                    Logger.getLogger(SimDrivelanePanel.class.getName()).log(Level.SEVERE, null, e);
                    done = false;
                    resetTryCount--;
                    reset();
        ...
        private class RULinkListener implements ActionListener {
            ...
            public RULinkListener(Roaduser ru) {
                this.ru = ru;
            }

            public void setRoaduser(Roaduser ru) {
                this.ru = ru;
            }

            @Override
            public void actionPerformed(ActionEvent e) {
                confd.showRoaduser(ru);
            }
        }

        @Override
        public Dimension getPreferredSize() {
            return new Dimension(130, counter * 20);
        }
    }
