...
public class SimEdgeNodePanel extends ConfigPanel implements ItemListener, ActionListener {
    ...
    Hyperlink wqlLink, twtLink, ruaLink, roadLink, nodeLink, dSpawnLink;
    Label[] queue;
    ...
    public SimEdgeNodePanel(ConfigDialog cd, EdgeNode e) {
        ...
        dSpawnLink.setBounds(0, 165, 220, 20);
        add(dSpawnLink);
    ...
    public void reset() {
        ...
        try {
            ...
            Logger.getLogger(SimEdgeNodePanel.class.getName()).log(Level.SEVERE, null, e);
            reset();
        }
    }
    ...
    public void setSpawnType() {
        try {
            ...
            Logger.getLogger(SimEdgeNodePanel.class.getName()).log(Level.SEVERE, null, ex);
