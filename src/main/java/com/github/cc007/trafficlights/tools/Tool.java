...
import com.github.cc007.trafficlights.Overlay;
import com.github.cc007.trafficlights.View;
...
public interface Tool extends Overlay {
    ...
    /**
     * Invoked when this tool is selected as the current tool. The panel will
     * returned will be added to the end of the toolbar, allowing the current
     * tool to add tool specific controls to the toolbar. The tool should take
     * care of the listeners.
     */
