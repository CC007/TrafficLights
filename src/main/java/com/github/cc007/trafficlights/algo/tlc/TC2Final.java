 ...
 * @version 1.0
 */
public class TC2Final extends TCRL implements Colearning,InstantiationAssistant
{
	// TLC vars
	...
	*/
	...
	protected void recalcQ(int tlId, int pos, int desId, boolean light, Sign newSign, int posNew, PosMov[] posMovs, int Ktl, Roaduser ru, boolean isWaiting, int penalty)
