 ...
 * @version 1.0
 */
public class TC2TLCDestless extends TCRL implements Colearning, InstantiationAssistant {
    // TLC vars
    ...
    public void setInfrastructure(Infrastructure infra) {
        ...
        try {
            ...
            Logger.getLogger(TC2TLCDestless.class.getName()).log(Level.SEVERE, null, e);
        }
