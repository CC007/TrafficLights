 ...
 * @version 2.0
 */
public class TCA1 extends TCRL implements Colearning, InstantiationAssistant {
    // TLC vars
    ...
    protected final static String shortXMLName = "tlc-a1";
     ...
     */
    public TCA1(Infrastructure infra) throws InfraException {
        super(infra);
    }
    ...
    public void setInfrastructure(Infrastructure infra) {
        ...
        try {
            ...
            Logger.getLogger(TCA1.class.getName()).log(Level.SEVERE, null, e);
        }
