 ...
 * @version 1.2
 */
public class SL6TLC extends TCRL implements InstantiationAssistant {
...
//OBS       // Her burde laves et tjek p� om 0 < gamma < 1 og det samme med random chance
    ...
    public Object createInstance(Class request) throws
        ...
        if (CountEntry.class.equals(request)) {
            ...
            throw new ClassNotFoundException("SL6 IntstantiationAssistant cannot make instances of "
                    + request);
        }
    }
