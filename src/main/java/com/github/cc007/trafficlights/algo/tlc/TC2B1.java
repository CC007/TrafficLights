...
public class TC2B1 extends TCRL implements Colearning, InstantiationAssistant {
    ...
    // TC2 vars
    protected ArrayList[][][] count, pTable, pKtlTable;
    ...
    public void setInfrastructure(Infrastructure infra) {
        ...
        try {
            ...
            Logger.getLogger(TC2B1.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    protected void recalcQ(int tlId, int pos, int desId, boolean light, int tlNewId, int posNew, PosMov[] posMovs, int Ktl, int penalty) {	// Meneer Kaktus zegt: OK!
    ...
    protected void recalcV(int tlId, int pos, int desId) {	// Meneer Kaktus zegt: V waarden worden wel erg groot!
