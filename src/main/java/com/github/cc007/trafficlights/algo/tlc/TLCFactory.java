...
public class TLCFactory {
    ...
    protected static final int[][] categoryTLCs = {
        ...
        {TC1_FIX, TC_1OPT, TC_2OPT, TC_3OPT, TC1_B1, TC2_B1, TC3_B1, TC_1_DESTLESS, TC_2_DESTLESS, TC_3_WORKINPROGRESS, TC_2FINAL, TC_2B, TC_2BAnco},
    ...
    public TLController getInstanceForLoad(int algoId) throws InfraException {
        switch (algoId) {
            ...
            case TC_CBG:
                return new TCCBG(infra);   //(DOAS 05)
            case TC_ABG:
