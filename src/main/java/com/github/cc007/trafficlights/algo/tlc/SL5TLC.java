 ...
 *
 * Changed to use Sarsa(0) with randaom decision instead of DP - S. Louring
 *------------------------------------------------------------------------*/
 ...
 * @version 1.1
 */
public class SL5TLC extends TCRL implements InstantiationAssistant {
    ...
    protected final static String shortXMLName = "tlc-sl5";
    ...
    public SL5TLC(Infrastructure infra) throws InfraException {
        ...
        //		System.out.println("pos = " + num_pos_on_dl);
    ...
    public TLDecision[][] decideTLs() {
        ...
        time_step++;
        random_chance = 0.5f * (1.0f / ((float) Math.sqrt(time_step)));
...
//OBS		// Her burde laves et tjek p� om 0 < gamma < 1 og det samme med random chance
    ...
    public void loadSecondStage(Map maps) throws XMLInvalidInputException, XMLTreeException {
        ...
        System.out.println("SL5 second stage load finished.");
    }
    ...
    public Object createInstance(Class request) throws
        ...
        if (CountEntry.class.equals(request)) {
            ...
            throw new ClassNotFoundException("SL5 IntstantiationAssistant cannot make instances of "
                    + request);
        }
    }
