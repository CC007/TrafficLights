...
public class ACGJ4 extends TLController implements InstantiationAssistant,XMLSerializable
{
	...
	protected class Population implements XMLSerializable
	{
		...
		{	byte[] ma1 = ma.getReproGenes(CROSSOVER_CHANCE,MUTATION_CHANCE);
			...
			Individual[] kids = {new Individual(ma1,pa1),new Individual(ma2,pa2)};
			return kids;
		}
