 ...
 *
 * This algorithm creates for every new cycle of iteration a genetic population
 * and tries to find the optimal city-wide configuration. This algorithm
 * prevents deadlocks and stimulates green waves. This algorithm prevents
 * endless waiting of roadusers. The fitness function "calcfitness" is the most
 * important function of this algorithm.
 *
...
public class ACGJ1 extends TLController implements XMLSerializable, TwoStageLoader, InstantiationAssistant {
    ...
    private class Population implements XMLSerializable, TwoStageLoader {
        ...
        public boolean createNextGeneration() {
            ...
            if (memSize == 0) {
                ...
                while (members.size() < popSize) {
                    ...
                    Person parent1 = members.get(p1);
                    Person parent2 = members.get(p2);
        ...
        public void setParentName(String parentName_) throws XMLTreeException {
            throw new XMLTreeException("Operation not supported. ACGJ1Population has a fixed parentname");
        }

        @Override
        public void loadSecondStage(Map maps) throws XMLTreeException, XMLInvalidInputException {
            XMLUtils.loadSecondStage(members, maps);
        }
    }
    ...
    private class Person implements XMLSerializable, TwoStageLoader {
        ...
        /**
         * This is the fitness-function, it now returns the number of cars that
         * can drive with the given config.
         */
    ...
    private class NodeInfo implements XMLSerializable, TwoStageLoader {
        ...
        @Override
        public void saveChilds(XMLSaver saver) throws XMLTreeException, IOException, XMLCannotSaveException { 	// NodeInfo objects don't have child objects
        }
    ...
    public void loadSecondStage(Map<String, Map<Integer, TwoStageLoader>> maps) throws XMLInvalidInputException, XMLTreeException {
        ...
        genPopulation.loadSecondStage(maps);
    }
    ...
    public Object createInstance(Class request) throws
        ...
        if (Population.class.equals(request)) {
            ...
            throw new ClassNotFoundException("ACGJ1 InstantiationAssistant cannot make instances of "
                    + request);
        }
    }
