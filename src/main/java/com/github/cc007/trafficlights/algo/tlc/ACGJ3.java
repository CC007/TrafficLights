...
public class ACGJ3 extends TLController implements InstantiationAssistant, XMLSerializable {
    ...
    /**
     * The pseudo-random number generator for generating the chances that
     ...
     * trafficlight. Till date it hasnt functioned that well. Rather poorly, to
     * just say it.
     *
    ...
    /**
     * Provides the TLC-algorithm with information about a roaduser that has had
     * it's go in the moveAllRoaduser-cycle. From this information it can be
     * distilled whether a roaduser has moved or had to wait.
     *
     * @param _ru
     * @param _prevlane
     * @param _prevsign
    ...
    protected class ACGJ3Population implements XMLSerializable {
         ...
         * @param _num_gen the number of generations there should be evolved
         * over
        ...
        protected ACGJ3Population() { 	// Empty constructor for loading
        }
         ...
         * if all individuals in this generation have been used, it evolves into
         * a new generation and returns a new Individual from that generation.
         */
        ...
        /**
         * Evolves the current generation of ACGJ3Individuals in the
         * ACGJ3Population into a new one.
         */
        ...
        public void setParentName(String parentName_) throws XMLTreeException {
            throw new XMLTreeException("Operation not supported. ACGJ3Population has a fixed parentname");
        }
    }
    ...
    protected class ACGJ3Individual implements XMLSerializable {
        ...
        /**
         * The array of float values that describe this ACGJ3Individual. Hence
         * the name of the array. Encoded are for every TrafficLight in the
         * Infrastructure: a float value 'weight per waiting roaduser' a float
         * value 'degrading/increasement weight per Roaduser waiting further up
         * the Queue' a float value 'gain-bucket' in which all the weights of
         * waiting Roadusers are collected a float value 'number of Roadusers
         * waiting' which is needed to make decreasement of the gain-bucket
         * possible
         */
        protected float[][][] me;
        protected int wait;
        ...
        /**
         * Creates a new ACGJ3Individual, providing the Infrastructure it should
         * run on
         */
        ...
        /**
         * Creates a new ACGJ3Individual, providing the reproduction genes from
         * daddy and mummy
         */
        ...
        /**
         * Returns the fitness of the current Individual, as was set at
         * iterating through this generation
         */
        ...
        /**
         * Sets the amount of Roadusers that did move during this Individual's
         * lifespan
         *
         * @param _move
         */
        ...
        /**
         * Returns the amount of Roadusers that did move during this Individuals
         * lifespan
         */
         ...
         * Roadusers are waiting/voting for their TrafficLight to be set to
         * green.
         *
         * @param node The Id of the Node of which a bucket has to be emptied a
         * bit
         * @param tl The TrafficLight of which a bucket has to be partly emptied
         * in the TLDecision[][]
         */
        ...
        /**
         * When a Roaduser may drive according to it's Sign, but cant as the
         * desired DriveLane is full, (some/all) of the current gain-bucket of
         * it's current TrafficLight is siphoned over to the desired DriveLane,
         * making it more probable that that lane will move, making it possible
         * for this DriveLane to move.
         *
         * @param node the Id of the Node at which the Roaduser is waiting
         * @param sign The TrafficLight the Roaduser is waiting for
         * @param des The TrafficLight that controls the traffic on the desired
         * DriveLane
         */
    ...
    public Object createInstance(Class request) throws
        ...
        if (ACGJ3Population.class.equals(request)) {
            ...
            throw new ClassNotFoundException("ACGJ3 InstantiationAssistant cannot make instances of "
                    + request);
        }
    }
