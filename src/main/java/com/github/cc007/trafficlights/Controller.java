...
public abstract class Controller extends Frame implements XMLSerializable {
 ...
 /*============================================*/
    ...
    /**
     * Shows the config dialog if it is hidden, hides it, if it is currently
     * showing
     */
...
//		mainController.showError("An internal error ocurred");
    ...
    public boolean validateInfra() {
        try {
            ...
            ArrayList<String> errors = v.validate();
            if (!errors.isEmpty()) {
                String errorString = "";
 ...
 /*============================================*/
    ...
    @Override
    public void saveChilds(XMLSaver saver) throws XMLTreeException, IOException, XMLCannotSaveException { 	// A controller has no childs in the XML structure. The model and view
    ...
    public void setParentName(String parentName) throws XMLTreeException {
        throw new XMLTreeException("Cannot set parent for XML root class controller");
    }
