 ...
 * @version 1.0
 */
public abstract class Node implements Selectable, XMLSerializable,
 ...
 /*============================================*/
     ...
     *
     * @param ruType The roaduser type to return statistics of. (0 if all
     * roadusers)
     */
     ...
     * constant, see above)
     * @returns The Direction from src to dest (expressed in D_ constants, see
     * above in Object variables of Node)
     */
    ...
    /**
     * Calculates the number of positions a roaduser can skip in the tail of its
     * destination lane
     *
 ...
 /*============================================*/
    ...
    public void processStats(Roaduser ru, int cycle, Sign sign) {
        ...
        statistics[RoaduserFactory.ruTypeToStatIndex(ru.getType())].addRoaduser(
                delay);
    }
    ...
    /**
     *
     * Basic node statistics. Class to maintain statistics for one roaduser
     * type.
     *
    ...
    public class NodeStatistics implements Cloneable, XMLSerializable {
         ...
         */
        private void setDelayTable(int[] dt) {
            delayTable = dt;
        }

        /**
         * Returns the total number of roadusers that crossed/arrived at this
         * node.
         */
         ...
         *
         * @param allTime Returns an all-time average if true, the average of
        ...
        public void load(XMLElement myElement, XMLLoader loader) throws
            ...
            avgWaitingTime = myElement.getAttribute("avg-waiting-time").
                    getFloatValue();
        ...
        public XMLElement saveSelf() throws XMLCannotSaveException {
            ...
            result.addAttribute(new XMLAttribute("avg-waiting-time",
                    avgWaitingTime));
 ...
 /*============================================*/
    ...
    public Object createInstance(Class request) throws
        ...
        if (NodeStatistics.class.equals(request)) {
            ...
            throw new ClassNotFoundException("Node IntstantiationAssistant cannot make instances of "
                    + request);
        }
    }
 ...
 /*============================================*/
    ...
    public abstract void paint(Graphics g, int offx, int offy, float zf) throws
            GLDException;
 ...
 /*============================================*/
    ...
    /**
     * Returns the name of this node. The name of a node is unique in an
     * infrastructure.
     */
    ...
    /**
     * Resets the data of this node. This also resets all AlphaRoads. @see
     * Road#reset()
     */
    public void reset() {
        resetStats();
     ...
     * @throw InfraException if a road is already connected at the given
     * position
     ...
     * @throw InfraException if the given position is not a valid
     * connection-position
     */
    ...
    /**
     * Returns whether or not all the Tails of all the outbound lanes of this
     * Node are free or not
     */
