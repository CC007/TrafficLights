...
public class SimpleInfra extends Infrastructure
{
	public SimpleInfra()
	{
		...
		try {
			...
			EdgeNode edge2 = new EdgeNode(new Point(0,0));
			...
			Node[] nodes = {edge0,edge1,edge2,node3};
			EdgeNode[] edges = {edge0,edge1,edge2};
			...
			SpawnFrequency sf3a = new SpawnFrequency(1,0.25f);
			SpawnFrequency sf3b = new SpawnFrequency(2,0.0f);
			SpawnFrequency sf3c = new SpawnFrequency(4,0.0f);
			SpawnFrequency[] sfa3 = {sf3a, sf3b, sf3c};
			edge2.setSpawnFrequencies(sfa3);
