...
public class SimMenuBar extends MenuBar {
    ...
    public SimMenuBar(SimController sc, String[] speedTexts) {
        ...
        // (DOAS 06)
        accidentsOn = new CheckboxMenuItem("Accidents", true);  // The default check value must correspond to the default value in the SimController
        ...
        // (DOAS 06)
        reroutingOn = new CheckboxMenuItem("Rerouting", true);  // The default check value must correspond to the default value in the SimController
