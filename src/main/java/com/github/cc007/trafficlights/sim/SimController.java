...
public class SimController extends Controller implements Observer {
    ...
    public SimController(SimModel m, boolean splash) {
        ...
        Iterator it = new ArrayList<>(Arrays.asList(speedTexts)).iterator();
        while (it.hasNext()) {
 ...
 /*============================================*/
    ...
    public static int getMaxRuWaitingQueue() {
        return maxRuWaitingQueue;
    }

    public static void setMaxRuWaitingQueue(int num) {
        maxRuWaitingQueue = num;
    }
    ...
    public void setHecAddon(boolean b) {
        ...
        try {
            ...
            Logger.getLogger(SimController.class.getName()).log(Level.SEVERE, null, e);
        }
        ...
        if (curSeries > 0) {
            ...
            for (int i = 0; i < tca.length; i++) {
                ...
                try {
                    ...
                    Logger.getLogger(SimController.class.getName()).log(Level.SEVERE, null, exc);
