...
public class Arrayutils {
    ...
    /**
     * Adds an element to the end of an array. Although the return type is an
     * Object, you can cast it to an array of the same type as ar.
     *
     ...
     */
    public static Object add(Object ar, Object elem) {
    ...
    /**
     * Adds an element to the end of an array, if and only if the element is not
     * already in the array. Comparison is done using the == operator, NOT the
     * Object.equals method. Although the return type is an Object, you can cast
     * it to an array of the same type as ar.
     *
     * @param ar The array to add an element to.
     * @param elem The element to add to the end of the array.
     * @return A new array with the same elements as ar, with elem at the end.
     */
    public static Object addUnique(Object ar, Object elem) {
    ...
    /**
     * Creates a new array containing the elements of two arrays. The elements
     * of the first array will be located at the front of the resulting array,
     * while the elements of the second will appear at the end. This order is
     * guaranteed. Although the return type is an Object, you can cast it to an
     ...
     * @return A new array with the same elements as ar, with all elements of
     * arrtoadd added at the end.
     */
     ...
     * Comparison is done using the == operator, NOT Object.equals. This means
     * the null element will appear once in the result, iff it appears at least
     * once in either of the two input arrays. The order of the elements is the
     * same as the two input arrays, with the elements of the first array up
     * front. Although the return type is an Object, you can cast it to an array
     * of the same type as the first (or second for that matter) array.
     *
     * @param ar1 The array to add the other array to.
     * @param ar2 The array to add at the end of the first array.
     * @return A new array with the unique elements of the first and second
     * array.
     */
    ...
    /**
     * Removes the element at given position, and moves all elements above that
     * 1 position down. Although the return type is an Object[], you can cast it
     * to an array of the same type as ar.
     *
     * @param ar The array to remove the element from.
     * @param pos The position of the element to remove.
     * @return A new array containing all elements of ar, except the element at
     * position pos.
     */
    public static Object remElement(Object ar, int pos) {
        ...
        if (pos != arl - 1) {
            System.arraycopy(ar, pos + 1, newar, pos, arl - pos - 1);
        }
        return newar;
    }

    /**
     * Removes an element from an array. Not an equals method is used, but a
     * direct == comparison. This method will thus only remove the exact same
     * element from the array. Although the return type is an Object[], you can
     * cast it to an array of the same type as ar.
     *
     * @param ar The array to remove the element from.
    ...
    /**
     * Replaces an element in an array with another. Although the return type is
     * an Object[], you can cast it to an array of the same type as ar.
     *
     ...
     * @return The index of the element in the array. If the element is not in
     * the array, returns -1.
     */
    public static int findElement(Object ar, Object elem) {
        int arl = Array.getLength(ar);
        for (int i = 0; i < arl; i++) {
            if (Array.get(ar, i) == elem) {
                return i;
            }
        }
        return -1;
    ...
    public static Object[] randomizeArray(Object[] ar) {
        Random r = new Random(GLDSim.seriesSeed[GLDSim.seriesSeedIndex]);
        int newplace, place;
    ...
    /**
     * Change the size of an array. If the size of the array increases, then
     * fill the new elements of the array (at the end) with new instances of a
     * specific class.
     *
     * @param input The original array
     * @param newLength The new length of the array
     * @param newClass The class of the new elements. It is necessary that
     * objects of this class can be instantiated with Class.newInstance. If the
     * new length is less than the old length of the array, then this parameter
     * is irrelevant.
     * @returns The result array
     * @throws ClassNotFoundException If this method wants to create objects,
     * but it cannot find the class that newClass is referring to.
     * @throws InstantiationException If this method wants to create objects,
    ...
    /**
     * Crops an array to specified length. Removes all elements after the
     * specified length.
     *
     ...
     * @return A new array with all the elements of the original array in its
     * second dimension
     */
...
/*
     ...
     * is a "normal class" then the classname is converted to the standard
     * notation. Names of primitive types are *NOT* converted (see
     * java.lang.Class documentation for their meanings).
     */
     ...
     * method accepts normal class names and the one letter designations for
     * primitive types as used in java.lang.Class.
     * @param length The length of the array. Positive int of course.
     * @returns The resulting array
     * @throws ClassNotFoundException It's all in the name
     */
    public static Object createSingleArray(String className, int length) throws ClassNotFoundException { // Yes, this is ugly.
     ...
     */
    public static Iterator getIterator(Object[] ar) {
        return new ArrayIterator(ar);
    }

    /**
     * Returns an Iterator over the given 2d array
     */
    public static Iterator getIterator(Object[][] ar) {
        return new ArrayIterator(ar);
    }
