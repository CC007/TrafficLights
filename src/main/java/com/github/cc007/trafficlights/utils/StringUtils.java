...
public class StringUtils {
    ...
    /**
     * Replace instances of strings in the from-array in the first string with
     * their counterpart in the to-array.
     *
    ...
    /**
     * Replace instances of chars in the from-array in the first string with
     * their counterpart in the to-array. This method is way more efficient than
     * the replaceList(String,String[],String[]) method.
     *
     * @param string The input string
