...
public class TurnCurve extends QuadCurve2D.Double {
    ...
    /**
     * Returns true if this TurnCurve is actually a straight line, false
     * otherwise
     */
    ...
    /**
     * Let the PathIterator do a step and if successfull return the coordinates
     * of it's current position
     *
     * @return The coordinats of the PathIterator's position, or null if no step
     * was possible
     *
     */
    public Point next() {
