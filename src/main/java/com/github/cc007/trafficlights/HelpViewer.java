...
public class HelpViewer extends JFrame {
    ...
    /**
     * Constant for use with <code>showHelp(int index)</code>, indicating to
     * show the help index.
     */
    ...
    /**
     * Constant for use with <code>showHelp(int index)</code>, indicating to
     * show the license for this application.
     */
    public static final int HELP_LICENSE = 2;
    /**
     * Constant for use with <code>showHelp(int index)</code>, indicating to
     * show the website of this application.
     */
    ...
    protected void toURL(String s) {
        try {
            ...
            Logger.getLogger(HelpViewer.class.getName()).log(Level.SEVERE, null, exc);
    ...
    protected void toURL(URL url) {
        try {
            ...
            Logger.getLogger(HelpViewer.class.getName()).log(Level.SEVERE, null, exc);
            controller.showError("Couldn't view help item \"" + url + "\" : " + exc);
        }
    }
